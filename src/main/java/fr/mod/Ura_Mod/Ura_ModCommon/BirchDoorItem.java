...
public class BirchDoorItem extends Item
{

    public BirchDoorItem()
    {
        this.maxStackSize = 1;
        this.setCreativeTab(Ura_ModMain.FururModCreativeTabs);
        this.setUnlocalizedName("birch_door_item");
        this.setTextureName(Ura_ModMain.MODID + ":birch_door");
    }
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            ++y;
            Block block = Ura_ModMain.birch_door;
