...
public class barrel extends Block {
    ...
    protected barrel(Material material) {
        super(material);
    ...
    {
        this.blockIcon = iiconRegister.registerIcon(Ura_ModMain.MODID + ":barrel");
        this.side = iiconRegister.registerIcon(Ura_ModMain.MODID + ":barrel_side");
        this.top = iiconRegister.registerIcon(Ura_ModMain.MODID + ":barrel_top");
        this.bottom = iiconRegister.registerIcon(Ura_ModMain.MODID + ":barrel_bottom");
    }
