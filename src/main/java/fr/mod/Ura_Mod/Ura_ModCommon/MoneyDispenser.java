...
public class MoneyDispenser extends Block {
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Ura_ModMain.MODID + ":money_dispenser");
        this.Front = p_149651_1_.registerIcon(Ura_ModMain.MODID + ":money_dispenser_front");
        this.Top = p_149651_1_.registerIcon(Ura_ModMain.MODID + ":money_dispenser_top");
    }
