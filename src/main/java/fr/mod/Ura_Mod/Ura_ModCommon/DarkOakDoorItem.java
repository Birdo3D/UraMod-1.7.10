...
public class DarkOakDoorItem extends Item
{
    ...
    public DarkOakDoorItem()
    {
        this.maxStackSize = 1;
        this.setCreativeTab(Ura_ModMain.FururModCreativeTabs);
        this.setUnlocalizedName("dark_oak_door_item");
        this.setTextureName(Ura_ModMain.MODID + ":dark_oak_door");
    }
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            ++y;
            Block block = Ura_ModMain.dark_oak_door;
