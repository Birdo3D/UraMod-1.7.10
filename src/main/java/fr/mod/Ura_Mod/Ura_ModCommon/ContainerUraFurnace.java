...
{
    private TileEntityUraFurnace tileFurnace;


    public ContainerUraFurnace(InventoryPlayer p_i1812_1_, TileEntityUraFurnace p_i1812_2_)
    {
        ...
        this.addSlotToContainer(new Slot(p_i1812_2_, 2, 21, 35));
...
public class ContainerUraFurnace extends Container {
    ...
    public ContainerUraFurnace(TileEntityUraFurnace tileEntityFurnace,InventoryPlayer inventoryPlayer )
    {
        this.tileMachineTuto = tileEntityFurnace;
        this.addSlotToContainer(new Slot(tileEntityFurnace, 0, 56, 17));
        this.addSlotToContainer(new Slot(tileEntityFurnace, 1, 56, 53));
        this.addSlotToContainer(new Slot(tileEntityFurnace, 2, 24, 35));
        this.addSlotToContainer(new SlotResult(tileEntityFurnace, 3, 116, 35));
Blocks.furnace
    ...
    public ContainerUraFurnace(TileEntityUraFurnace tile, InventoryPlayer inventory)
    {
    ...
    //    this.addSlotToContainer(new Slot(tile, 2, 129, 75));
        this.addSlotToContainer(new SlotResult(tile, 2, 116, 35)); //Ici c'est un slot que j'ai créer, on le fera après
