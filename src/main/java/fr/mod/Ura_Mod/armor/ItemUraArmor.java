...
public class ItemUraArmor extends ItemArmor {
    public ItemUraArmor(ArmorMaterial material, int type)
    {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
    {
        if(slot == 2)
        {
            return Ura_ModMain.MODID + ":textures/models/armor/ura_armor_layer_2.png";
        }
        return Ura_ModMain.MODID + ":textures/models/armor/ura_armor_layer_1.png";
    }
