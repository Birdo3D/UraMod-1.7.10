...
public class ItemHalloweenArmor extends ItemArmor {

    public ItemHalloweenArmor(ArmorMaterial material, int type)
    {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
    {
        if(slot == 2)
        {
            return Ura_ModMain.MODID + ":textures/models/armor/halloween_armor_layer_2.png";
        }
        return Ura_ModMain.MODID + ":textures/models/armor/halloween_armor_layer_1.png";
    }
