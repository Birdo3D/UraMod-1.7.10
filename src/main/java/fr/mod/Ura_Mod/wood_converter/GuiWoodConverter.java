...
public class GuiWoodConverter extends GuiContainer{
    private static final ResourceLocation texture = new ResourceLocation(Ura_ModMain.MODID,"textures/gui/container/gui_wood_converter.png");
    ...
    {
        super(new WoodConverterContnaier( inventory,tile));
        ...
        if(this.tileEntityWoodConverter.getStackInSlot(0)!=null&&this.tileEntityWoodConverter.getStackInSlot(1)==null) {
            if(tileEntityWoodConverter.getStackInSlot(0).getItem() instanceof ItemBlock ){
                if(Block.getBlockFromItem(tileEntityWoodConverter.getStackInSlot(0).getItem())==Blocks.log||Block.getBlockFromItem(tileEntityWoodConverter.getStackInSlot(0).getItem())==Blocks.log2){
                    if (this.tileEntityWoodConverter.getStackInSlot(0) != null && this.tileEntityWoodConverter.getStackInSlot(1) == null) {
                        Ura_ModMain.network.sendToServer(new WoodConverterPackets(p_146284_1_.id,tileEntityWoodConverter.xCoord,tileEntityWoodConverter.yCoord,tileEntityWoodConverter.zCoord));
                      /*  switch (p_146284_1_.id) {
                            case 200:
                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log, this.tileEntityWoodConverter.getStackInSlot(0).stackSize));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                            case 201:
                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log2, this.tileEntityWoodConverter.getStackInSlot(0).stackSize));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                            case 202:

                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log, this.tileEntityWoodConverter.getStackInSlot(0).stackSize,1));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                            case 203:

                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log, this.tileEntityWoodConverter.getStackInSlot(0).stackSize,2));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                            case 204:
                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log, this.tileEntityWoodConverter.getStackInSlot(0).stackSize,3));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                            case 205:
                                this.tileEntityWoodConverter.setInventorySlotContents(1, new ItemStack(Blocks.log2, this.tileEntityWoodConverter.getStackInSlot(0).stackSize,1));
                                this.tileEntityWoodConverter.setInventorySlotContents(0, null);
                                break;
                                }
*/
...
/*
        ...
        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack, k+57, l+24);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack, k+57, l+24);

        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack2, k+80, l+24);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack2, k+80, l+24);

        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack3, k+103, l+24);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack3, k+103, l+24);


        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack4, k+57, l+47);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack4, k+57, l+47);

        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack5, k+80, l+47);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack5, k+80, l+47);

        itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack6, k+103, l+47);
        itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), itemstack6, k+103, l+47);
        GL11.glDisable(GL11.GL_LIGHTING);
