...
public class SmithingTableGui extends GuiContainer {
    private static final ResourceLocation texture = new ResourceLocation(Ura_ModMain.MODID,"textures/gui/container/smithing_table.png");
    @SuppressWarnings("unused")
    private SmithingTableTileEntity iriduimSmithingTableTileEntity;
    private IInventory playerInv;

    public SmithingTableGui(SmithingTableTileEntity tile, InventoryPlayer inventory, World world)
    {
        super(new SmithingTableContnaier(inventory,tile,world));
