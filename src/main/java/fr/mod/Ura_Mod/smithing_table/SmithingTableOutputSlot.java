...
public class SmithingTableOutputSlot extends Slot {
    ...
    private final SmithingTableContnaier contnaier;
    ...
    public SmithingTableOutputSlot(SmithingTableContnaier smithingTableContnaier,IInventory iInventory, int slotIndex, int slotX, int slotY, World world, int blockX, int blockY, int blockZ) {
        super(iInventory, slotIndex, slotX, slotY);
        this.contnaier = smithingTableContnaier;
        this.theWorld = world;
    ...
    public void onPickupFromSlot(EntityPlayer entityPlayer, ItemStack itemStack) {
        ...
        if(!this.theWorld.isRemote && this.theWorld.getBlock(this.blockPosX, this.blockPosY, this.blockPosZ) instanceof SmithingTable){
            ...
            if(tile instanceof SmithingTableTileEntity){
                SmithingTableTileEntity iriduimSmithingTableTileEntity = (SmithingTableTileEntity) tile;
