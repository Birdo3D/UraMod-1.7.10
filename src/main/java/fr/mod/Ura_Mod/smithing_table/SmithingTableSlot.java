...
public class SmithingTableSlot extends Slot {
    ...
    public SmithingTableSlot(SmithingTableContnaier smithingTableContnaier, IInventory iInventory, int slotIndex, int slotX, int slotY, World world, int blockX, int blockY, int blockZ) {
