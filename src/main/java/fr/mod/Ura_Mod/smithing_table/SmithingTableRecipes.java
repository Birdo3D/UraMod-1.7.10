...
public class SmithingTableRecipes {
    ...
    private static final SmithingTableRecipes smeltingBase = new SmithingTableRecipes(); //Permet d'instancier votre classe car vous le l'instancierez nul part ailleur
    private Map smeltingList = new HashMap(); //Ceci permet de mettre vos recettes




    public SmithingTableRecipes()
    {
        this.addRecipe(Items.diamond_helmet,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_helmet));
        this.addRecipe(Items.diamond_chestplate,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_chestPlate));
        this.addRecipe(Items.diamond_leggings,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_leggings));
        this.addRecipe(Items.diamond_boots,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_boots));
        this.addRecipe(Items.diamond_pickaxe,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_pickaxe));
        this.addRecipe(Items.diamond_sword,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_sword));
        this.addRecipe(Items.diamond_shovel,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_shovel));
        this.addRecipe(Items.diamond_axe,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_axe));
        this.addRecipe(Items.diamond_hoe,Ura_ModMain.netherite_ingot, new ItemStack(Ura_ModMain.netherite_hoe));
    }
    ...
    public static fr.mod.Ura_Mod.smithing_table.SmithingTableRecipes smelting()
    {
        return smeltingBase;
    }
}