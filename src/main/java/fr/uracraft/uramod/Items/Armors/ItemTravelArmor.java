...
public class ItemTravelArmor extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
    {
        if(slot == 2)
        {
            return UraMod.MODID + ":textures/models/armor/travel_armor_layer_2.png";
        }
        return UraMod.MODID + ":textures/models/armor/travel_armor_layer_1.png";
    }
    public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
        if (this.armorType == 0) {
            player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 220, -1));
        }
